...
public class Boton_Etiqueta_canvas : MonoBehaviour
{
    public GameObject Botones_Etiqueta;
    // Start is called before the first frame update
    void Start()
    {
        if (Botones_Etiqueta != null)
            Botones_Etiqueta.SetActive(false); // asegura que el boton inicie oculto
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player")) // Asegurar que el objeto que entra es el jugador//if (other.gameObject.CompareTag("Material") && other.gameObject.CompareTag("Usuario")) // Asegurar que el objeto que entra es el jugador
        {
            ...
            Botones_Etiqueta.SetActive(true); // Mostrar el botón
        }
    ...
    public void OnTriggerExit(Collider other)
    {
        ...
        {
            Botones_Etiqueta.SetActive(false); // Ocultar el botón
        }
    }
